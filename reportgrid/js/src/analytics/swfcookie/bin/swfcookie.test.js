...
TestSwfCookie = function(p) {
}
TestSwfCookie.__name__ = ["TestSwfCookie"];
TestSwfCookie.cookie = null;
TestSwfCookie.main = function() {
	TestSwfCookie.cookie = new SwfCookie({ timeout : 2, debug : false, onready : TestSwfCookie.run, onerror : function() {
		haxe.Log.trace("error loading SwfCookie",{ fileName : "TestSwfCookie.hx", lineNumber : 97, className : "TestSwfCookie", methodName : "main"});
	}, batch_requests : true, batch_delay : 50});
}
TestSwfCookie.run = function() {
	var runner = new utest.Runner();
	runner.addCase(new TestSwfCookie());
	utest.ui.Report.create(runner);
	runner.run();
}
TestSwfCookie.prototype.teardown = function() {
	TestSwfCookie.cookie.clear();
}
TestSwfCookie.prototype.testGetSet = function() {
	utest.Assert.isNull(TestSwfCookie.cookie.get(TestSwfCookie.key),null,{ fileName : "TestSwfCookie.hx", lineNumber : 17, className : "TestSwfCookie", methodName : "testGetSet"});
	TestSwfCookie.cookie.set(TestSwfCookie.key,TestSwfCookie.value);
	utest.Assert.equals(TestSwfCookie.value,TestSwfCookie.cookie.get(TestSwfCookie.key),null,{ fileName : "TestSwfCookie.hx", lineNumber : 19, className : "TestSwfCookie", methodName : "testGetSet"});
}
TestSwfCookie.prototype.testClear = function() {
	TestSwfCookie.cookie.set(TestSwfCookie.key,TestSwfCookie.value);
	TestSwfCookie.cookie.clear();
	utest.Assert.isNull(TestSwfCookie.cookie.get(TestSwfCookie.key),null,{ fileName : "TestSwfCookie.hx", lineNumber : 26, className : "TestSwfCookie", methodName : "testClear"});
}
TestSwfCookie.prototype.testRemove = function() {
	TestSwfCookie.cookie.set(TestSwfCookie.key,TestSwfCookie.value);
	TestSwfCookie.cookie.remove(TestSwfCookie.key);
	utest.Assert.isNull(TestSwfCookie.cookie.get(TestSwfCookie.key),null,{ fileName : "TestSwfCookie.hx", lineNumber : 33, className : "TestSwfCookie", methodName : "testRemove"});
}
TestSwfCookie.prototype.testDelayedGet = function() {
	TestSwfCookie.cookie.set(TestSwfCookie.key,TestSwfCookie.value);
	utest.Assert.equals(TestSwfCookie.value,TestSwfCookie.cookie.get(TestSwfCookie.key),null,{ fileName : "TestSwfCookie.hx", lineNumber : 39, className : "TestSwfCookie", methodName : "testDelayedGet"});
	var async = utest.Assert.createAsync(function() {
		utest.Assert.equals(TestSwfCookie.value,TestSwfCookie.cookie.get(TestSwfCookie.key),null,{ fileName : "TestSwfCookie.hx", lineNumber : 42, className : "TestSwfCookie", methodName : "testDelayedGet"});
	},1000);
	haxe.Timer.delay(async,100);
}
TestSwfCookie.prototype.testSetObject = function() {
	TestSwfCookie.cookie.set("string","A");
	TestSwfCookie.cookie.setObject({ string : "B", 'int' : 1, float1 : Math.NaN, float2 : 0.1, array : [1,2,3], bool : true});
	utest.Assert.same({ string : "B", 'int' : 1, float1 : Math.NaN, float2 : 0.1, array : [1,2,3], bool : true},TestSwfCookie.cookie.getAll(),null,null,{ fileName : "TestSwfCookie.hx", lineNumber : 59, className : "TestSwfCookie", methodName : "testSetObject"});
}
TestSwfCookie.prototype.testGetAll = function() {
	TestSwfCookie.cookie.set("string","A");
	TestSwfCookie.cookie.set("int",1);
	TestSwfCookie.cookie.set("float1",Math.NaN);
	TestSwfCookie.cookie.set("float2",0.1);
	TestSwfCookie.cookie.set("array",[1,2,3]);
	TestSwfCookie.cookie.set("bool",true);
	utest.Assert.same({ string : "A", 'int' : 1, float1 : Math.NaN, float2 : 0.1, array : [1,2,3], bool : true},TestSwfCookie.cookie.getAll(),null,null,{ fileName : "TestSwfCookie.hx", lineNumber : 78, className : "TestSwfCookie", methodName : "testGetAll"});
}
TestSwfCookie.prototype.__class__ = TestSwfCookie;
...
js.Lib.onerror = null;
TestSwfCookie.key = "key";
TestSwfCookie.value = "value";
