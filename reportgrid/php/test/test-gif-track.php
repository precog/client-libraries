...
class TestGifTracking extends BaseTest {
	...
	function testUrl()
	{
		$expected = parse_url_detail('http://api.reportgrid.com/services/viz/gif/transparent.gif?tokenId=A3BC1539-E8A9-4207-BB41-3036EC2C6E6D&path=%2Ftest%2Fphp%2Fgiftrack&event=%7B%22conversion%22%3A%7B%22browser%22%3A%22Chrome%22%7D%7D&service=http%3A%2F%2Fdevapi.reportgrid.com%3A80%2Fservices%2Fanalytics%2Fv1%2F&rollup=1');

		$this->assertEqual($expected,
			parse_url_detail($this->rg->gifUrl($this->path, $this->event, array("rollup" => 1)))
		);
	}
