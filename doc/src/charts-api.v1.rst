...
In the parameters object (the second argument of every visualization method) you always have to set a data source this can be done by setting one of the following options:
