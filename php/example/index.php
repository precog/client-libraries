...
$report_grid = new ReportGridAPI('A3BC1539-E8A9-4207-BB41-3036EC2C6E6D');

echo "<br/>--------newToken--------<br/>";
$new_token = $report_grid->newToken("ddimarco/transaction", "9223372036854775807", true, true, true, 2, 2, 2);

if ( ($new_token == false) && ($report_grid->isError) ) {
    echo "<P>ERROR:  " . $report_grid->errorMessage;
    die();
} else {
...
echo "<P>TOKEN INFO: " . print_r($token_info, true);
...
$token_info = $report_grid->tokenInfo($new_token);
echo "<P>UPDATED TOKEN INFO: " . print_r($token_info, true);
