...
delete e.path;i[b]=c.extend({},{browserVersion:q,operatingSystem:l,platform:r,totalVisits:w,totalInteraction:u,totalEngagement:a(v+(+new Date-h),1E3),referrer:f,timeOffset:x,"~keywords":n},g||{});b=[j];if(d.rollup){j=j.split(/\//g);for(j.pop();j.length>0;)b.push("/"+j.join("/")+"/"+d.rollupName),j.pop()}return ReportGrid.track(b,c.extend({},e,{event:i}))},w=0,u=0,v=0;e("visited");var s=function(){if(t){var f=b;b=function(a,b){return arguments.length>1?(f(a,b),t.set(a,b),b):t.get(a)||f(a)}}var o=function(){for(var a=
"",c=0;c<32;++c)a+=(Math.random()*16>>>0).toString(16);l=!0;return b("reportgrid_identity",a)},l=!1;b("reportgrid_identity")||o();o=function(){var a=+new Date-function(){var a=b("reportgrid_last_visit")||+new Date;b("reportgrid_last_visit",+new Date);return a}();return a>2592E6?"yearly":a>6048E5?"monthly":a>864E5?"weekly":a>1E3?"hourly":"new"}();w+=b("reportgrid_total_visits",(+b("reportgrid_total_visits")||0)+1);v+=+b("reportgrid_total_engagement")||0;l?e("uniqueVisited"):e("repeatVisited",{timeFrame:o});
c(function(){e("loaded",{delay:a(+new Date-h,50)})});p(/https?:\/\/([^\/]+)\//,document.referrer)===(document.location.host||document.location.hostname)?+b("reportgrid_already_unbounced")||(o=+b("reportgrid_bounce_time"),b("reportgrid_already_unbounced",1),e("bounce",{},{path:b("reportgrid_bounce_path"),count:-1,timestamp:o})):(b("reportgrid_already_unbounced",0),o=+new Date,b("reportgrid_bounce_path",k),b("reportgrid_bounce_time",o),e("bounce",{},{timestamp:o}));c('a, button, input[type="submit"]').live("click",
function(){var a=this.nodeName.toLowerCase();e(a==="a"?"linkClicked":a==="button"?"buttonClicked":a==="input"?"submitClicked":a+"Clicked",{element:g(c(this)),newWindow:c(this).attr("target")==="_blank"})});c("form").live("submit",function(){var a={};c(this).find('select, input[type="checkbox"]').each(function(){a[g(c(this))]=c(this).val()});e("formSubmitted",a)});var i=0;d.scrolling&&setInterval(function(){var a=c(window).height(),b=c(window).scrollTop(),d=c("body").height(),a=(a+b)/d*10>>>0;a>i&&
(e("saw",{region:a}),i=a)},100);c("*").live("click",function(a){a.target===this&&(++u,d.interaction&&e("interaction",{element:g(c(this)),type:"click"}))});c("*").live("keypress",function(a){a.target===this&&a.which===13&&(++u,d.interaction&&e("interaction",{element:g(c(this)),type:"enterKey"}))});c('a[href^="mailto:"]').live("click",function(){e("emailed",{address:c(this).attr("href").replace(/^mailto:/,"")})});d.pageEngagement==="queueing"&&b("reportgrid_page_engagement_time")&&b("reportgrid_page_engagement_last_url")&&
e("engagedQueueing",{time:a(+b("reportgrid_page_engagement_time"),100),url:b("reportgrid_page_engagement_last_url")},{timestamp:+b("reportgrid_page_last_engagement_start_time")});b("reportgrid_page_engagement_last_url",k);b("reportgrid_page_last_engagement_start_time",+new Date);setInterval(function(){b("reportgrid_page_engagement_time",+new Date-h);b("reportgrid_user_total_engagement",v+(+new Date-h))},100);var j=function(b){setTimeout(function(){e("engagedPolling",{time:a(+new Date-h,1E3)});j(b*
2)},b)};d.pageEngagement==="polling"&&j(1E3);if(d.attention){var m=null,n=0,r=0,q=d.attentionResolution,s=1/q;c(d.attentionSelector+" *").live("mousemove",function(b){if(this===b.target){var d=c(this).offset(),f=b.pageY-d.top,b=a((b.pageX-d.left)/c(this).width(),s)*q>>>0,f=a(f/c(this).height(),s)*q>>>0;b===n&&f===r&&this===m||(m=this,n=b,r=f,e("attention",{element:g(c(this)),tileX:b,tileY:f}))}})}},t=null;d.crossdomain?c(function(){t=new SwfCookie({namespace:d.cookieNamespace,swf_url:"http://api.reportgrid.com/js/swfcookie.swf",
onready:s,onerror:function(){t=null;s()}})}):s()})(jQuery);
