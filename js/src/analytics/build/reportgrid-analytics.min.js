...
c(window).height(),b=c(window).scrollTop(),d=c("body").height(),a=(a+b)/d*10>>>0;a>i&&(e("saw",{region:a}),i=a)},100);c("*").live("click",function(a){console.log("click");a.target===this&&(console.log("click-logged"),++u,d.interaction&&e("interaction",{element:g(c(this)),type:"click"}))});c("*").live("keypress",function(a){a.target===this&&a.which===13&&(++u,d.interaction&&e("interaction",{element:g(c(this)),type:"enterKey"}))});c('a[href^="mailto:"]').live("click",function(){e("emailed",{address:c(this).attr("href").replace(/^mailto:/,
"")})});d.pageEngagement==="queueing"&&b("reportgrid_page_engagement_time")&&b("reportgrid_page_engagement_last_url")&&e("engagedQueueing",{time:a(+b("reportgrid_page_engagement_time"),1E3)},b("reportgrid_page_engagement_last_url"),new Date(+b("reportgrid_page_last_engagement_start_time")));b("reportgrid_page_engagement_last_url",k);b("reportgrid_page_last_engagement_start_time",+new Date);setInterval(function(){b("reportgrid_page_engagement_time",+new Date-h);b("reportgrid_user_total_engagement",
v+(+new Date-h))},200);var j=function(b){setTimeout(function(){e("engagedPolling",{time:a(+new Date-h,200)});j(b*2)},b)};d.pageEngagement==="polling"&&j(200);if(d.attention){var m=null,n=0,r=0,q=d.attentionResolution,s=1/q;c(d.attentionSelector+" *").live("mousemove",function(b){if(this===b.target){var d=c(this).offset(),f=b.pageY-d.top,b=a((b.pageX-d.left)/c(this).width(),s)*q>>>0,f=a(f/c(this).height(),s)*q>>>0;b===n&&f===r&&this===m||(m=this,n=b,r=f,e("attention",{element:g(c(this)),tileX:b,tileY:f}))}})}},
